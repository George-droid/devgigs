...
<div class="flex items-center justify-center">
    <div >
        ...
        <div class=" relative bg-white py-10 px-10 rounded-3xl w-64 my-8 shadow-xl" style="width: 650px; !important">
            ...
            <div class="mt-8">
                <p class="text-5xl font-semibold my-2">
                ...
                <div class="flex space-x-2 text-gray-400 text-sm my-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 512 512"><title>ionicons-v5-h</title>
                     ...
                     <p class="text-4xl">{{ $listing->company }}</p> 
                </div>
                <p class="text-4xl my-2">{{ $listing->description }}</p>
                <div class="flex space-x-2 text-gray-400 text-sm my-3">
                    <!-- svg  -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                     <p class="text-2xl">Contract Type</p> 
                </div>
                <div class="flex space-x-2 text-gray-400 text-sm">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     ...
                     <p class="text-2xl">{{ $listing->location }}</p> 
                </div>
